export const Bio = {
    ...
    github: "https://github.com/shrim167",
    resume:
  ...
  export const education = [
    ...
    {
      id: 1,
      img: "http://www.stccollegelibrary.com/GetConfigurationImg.ashx?id=SocietyLogo",
  ...
  export const projects = [
    {
      ...
      description:
        "• Developed ”Green the Map” web application showcasing interactive visualizations of garbage areas, user complaints, and smart bin maintenance data. • Implemented real-time updates using WebSocket communication to ensure seamless synchronization of smart bin data across devices.• Utilized data visualization libraries to present user complaints and garbage distribution patterns, aiding in informed waste management decisions.",
      image:
