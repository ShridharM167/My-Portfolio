...
import cheqLogo from "../images/cheq_one_logo.jpeg";
import dataLoreLabsLogo from "../images/DataloreLabs.jpeg";
import postmanLogo from "../images/postman_platform_logo.jpeg";
import gitLogo from "../images/gitLogo.png";
import nestJSLogo from '../images/nestJSLogo.svg';
...
export const Bio = {
  ...
  description:
    "Software Development Engineer with 4 years of experience in building high-performance full-stack web applications and delivering scalable solutions through cross-functional collaboration.",
  github: "https://github.com/shridhar-mugalkhod",
  resume:
    "https://drive.google.com/file/d/1ubTKCQXHEa2Aq8klP7rE6CNheLrlCY2P/view",
...
export const experiences = [
  {
    ...
    desc:
      "• Engineered a feature to identify fraudulent transactions and block associated CheQ user accounts, which enhanced system security and reduced fraud by 50%, thereby increasing user trust.\n" +
      "• Streamlined chargeback processing by automating the creation of records and notifications from emails received from multiple PG partners using Google Cloud Pub/Sub, reducing manual tasks by 80% and ensuring timely responses with daily reminders.\n" +
      "• Implemented a caching mechanism for repeated Gmail API calls, reducing unnecessary requests and improving email processing speed by 20%.\n" +
      "• Collaborated with stakeholders on product roadmap planning, solution design, system architecture, and technical feasibility, resulting in more efficient feature prioritization and sprint planning, which accelerated product delivery and ensured alignment with business objectives.",
    skills: [
      "JavaScript",
      "TypeScript",
      "ReactJS",
  ...
  },
  {
    ...
    desc:
      "• Developed and maintained Simnovator, a real-time web application that increased the efficiency of 5G network testing and monitoring, enabling faster analysis of network statistics and logs.\n" +
      "• Enhanced data visualization for long-term 5G network tests by improving statistical graphs and charts, leading to a 10% increase in user engagement.\n" +
      "• Facilitated data accessibility by introducing multi-format download options and compressing file sizes from 100 MB to 20 MB, achieving an impressive 80% reduction in user download times and improving overall efficiency.\n" +
      ...
      "• Adopted microservices architecture, enhancing system scalability and maintainability, which resulted in a 30% improvement in system performance.",
    skills: [
      "ReactJS",
      "NodeJs",
      "Material UI",
  ...
  },
  {
    ...
    skills: ["Machine Learing", "Python", "NumPy"],
  },
];
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Jira",
        image:
          "https://www.ecobit.nl/portal-content-website/koppelingen/jira%20software.png",
      },
      {
        name: "Confluence",
        image:
...
export const projects = [
  ...
  },
  {
    ...
    details:
      "• A personal portfolio website serves as an online showcase of skills, projects, and professional journey.\n" +
      "• It offers a comprehensive overview of qualifications and accomplishments, enhancing a resume by providing in-depth insights into work.",
    image: portfolioPage,
